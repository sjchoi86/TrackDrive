...
colors = flipud(jet(track.nr_seg));
...
for i = fliplr(1:track.nr_seg)
    ...
    % Start position
    plot_arrow(curr_pos(1:2), arrowlen, curr_pos(3), curr_color, 3);
...
%     plot(p1(1), p1(2), '^', 'MarkerSize', 15, 'Color', curr_color);
%     plot(p2(1), p2(2), 'v', 'MarkerSize', 15, 'Color', curr_color);
%     plot(p3(1), p3(2), '<', 'MarkerSize', 15, 'Color', curr_color);
%     plot(p4(1), p4(2), '>', 'MarkerSize', 15, 'Color', curr_color);
...
for i = fliplr(1:track.nr_seg)
    ...
    if i == 1
        text(text_pos(1), text_pos(2), sprintf('Start %d', i), 'FontSize', 18 ...
            , 'HorizontalAlignment', 'Left', 'Color', 'r');
    else
        text(text_pos(1), text_pos(2), sprintf('%d', i), 'FontSize', 18 ...
